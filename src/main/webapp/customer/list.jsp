...
<div class="container">
    <div class="row">
        <div class="col-md-7">
            <p>Below are client-side buttons demo, go here to see server-side buttons demo</p>
        ...
        <div class="col-md-5">
            <form method="post" action="/customers?act=search" class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-2" name="name" type="search" placeholder="Quick search" aria-label="Search">
